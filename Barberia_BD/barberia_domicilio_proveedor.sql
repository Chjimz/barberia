...
CREATE TABLE `domicilio_proveedor` (
  ...
  `Calle_Proveedor` varchar(255) NOT NULL,
  `Colonia_Proveedor` varchar(255) NOT NULL,
  `NumInt_Proveedor` int DEFAULT NULL,
  `NumExt_Proveedor` char(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `cp_Proveedor` int NOT NULL,
  PRIMARY KEY (`Id_Proveedor`),
  CONSTRAINT `FK_Domicilio_Proveedor_Proveedor` FOREIGN KEY (`Id_Proveedor`) REFERENCES `proveedor` (`Id_Proveedor`)
